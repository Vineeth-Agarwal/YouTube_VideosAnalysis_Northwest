...
o.write("------------------------------------\n")
print("Video ID  Video Name  Views  Likes\n")
print("------------------------------------\n")
for line in i:
    if count<5:
        ...
        print(video_id+"  "+video_name+"  "+str(int(round(float(views))))+"  "+str(int(round(float(likes))))+"\n")
        count += 1
o.write("The above are top 5 videos with most likeliness")
print("The above are top 5 videos with most likeliness")
i.close()
o.close()